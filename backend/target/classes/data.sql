...
-- ── Discount plans ───────────────────────────────────────────
-- Let the IDENTITY sequence assign IDs automatically
...
-- Provides meaningful data for reports and order-lifecycle demo.
-- Account IDs: CityPharmacy=8, Cosymed=9, HelloPharmacy=10 (IDENTITY seq, create-drop).
